...
serviceRouter.post('/startseite', function(request, response) {
    ...
    if (helper.isUndefined(request.body.laufzeit)) 
        errorMsgs.push('laufzeit fehlt');
    ...
    const startseiteDao = new StartseiteDao(request.app.locals.dbConnection);
    try {
        var obj = startseiteDao.create(request.body.bildpfad, request.body.preis, request.body.beschreibung, request.body.titel, request.body.fsk, request.body.uhrzeit1, request.body.uhrzeit2, request.body.uhrzeit3, request.body.tag1, request.body.tag2, request.body.tag3, request.body.laufzeit);
...
serviceRouter.put('/startseite', function(request, response) {
    ...
    const startseiteDao = new StartseiteDao(request.app.locals.dbConnection);
    try {
        var obj = startseiteDao.update(request.body.id, request.body.bildpfad, request.body.preis, request.body.beschreibung, request.body.titel, request.body.fsk, request.body.uhrzeit1, request.body.uhrzeit2, request.body.uhrzeit3, request.body.tag1, request.body.tag2, request.body.tag3, request.body.laufzeit);
