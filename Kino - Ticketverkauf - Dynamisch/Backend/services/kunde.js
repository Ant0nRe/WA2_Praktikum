...
serviceRouter.post('/kunde', function(request, response) {
    ...
    const kundeDao = new KundeDao(request.app.locals.dbConnection);
    try {
        var obj = kundeDao.create(request.body.vorname, request.body.nachname, request.body.email, request.body.strasse, request.body.plz, request.body.stadt, request.body.bundesland, request.body.zahlungsart);
...
serviceRouter.put('/kunde', function(request, response) {
    ...
    const kundeDao = new KundeDao(request.app.locals.dbConnection);
    try {
        var obj = kundeDao.update(request.body.id, request.body.vorname, request.body.nachname, request.body.email, request.body.strasse, request.body.plz, request.body.stadt, request.body.bundesland, request.body.zahlungsart);
